...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("bitdepth", "0000001.jp2"), "HathiJP200"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("colorspace", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("correct", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("empty_address", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("empty_city", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("empty_country", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("missing_creator", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("empty_state", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("empty_zip", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("empty_phonenumber", "0000001.jp2"), "HathJP2000"),
])
...
@pytest.mark.parametrize("test_file,profile_name", [
    ...
    (os.path.join("pixelarray", "0000001.jp2"), "HathJP2000"),
])
